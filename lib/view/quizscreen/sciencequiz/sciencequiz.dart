...
class ScienceQuiz_screen extends StatefulWidget {
  const ScienceQuiz_screen({super.key});

  @override
  State<ScienceQuiz_screen> createState() => _ScienceQuiz_screenState();
}

class _ScienceQuiz_screenState extends State<ScienceQuiz_screen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Text(
              "${questionindex + 1}/${questionobject.scienceQuizData.length}",
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      questionobject.scienceQuizData[questionindex]["question"],
                      style: TextStyle(
                ...
                ListView.separated(
                    ...
                    itemBuilder: (context, index) => InkWell(
                          onTap: () {
                            selectedindex = index;
                            if (selectedindex ==
                                questionobject.scienceQuizData[questionindex]
                                    ["answer"]) {
                              print(count);
                            }
                            //print(selectedindex);
                ...
                InkWell(
                  onTap: () {
                    ...
                    selectedindex = null;
                    if (questionindex <
                        questionobject.scienceQuizData.length - 1) {
                      questionindex++;
...
//answer check
  Color selectedanswer(int index) {
    if (selectedindex != null &&
        index == questionobject.scienceQuizData[questionindex]["answer"]) {
      return Color_const.mycustomgreen;
    }
    if (selectedindex == index) {
      if (selectedindex ==
          questionobject.scienceQuizData[questionindex]["answer"]) {
        return Color_const.mycustomgreen;
      } else {
