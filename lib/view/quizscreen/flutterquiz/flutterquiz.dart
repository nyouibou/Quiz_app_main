...
class FlutterQuiz_screen extends StatefulWidget {
  const FlutterQuiz_screen({super.key});

  @override
  State<FlutterQuiz_screen> createState() => _FlutterQuiz_screenState();
}

class _FlutterQuiz_screenState extends State<FlutterQuiz_screen> {
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      questionobject.codingQuizData[questionindex]["question"],
                      style: TextStyle(
                ...
                ListView.separated(
                    ...
                    itemBuilder: (context, index) => InkWell(
                          onTap: () {
                            selectedindex = index;
                            if (selectedindex ==
                                questionobject.codingQuizData[questionindex]
                                    ["answer"]) {
                              print(count);
                            }
                            //print(selectedindex);
                ...
                InkWell(
                  onTap: () {
                    ...
                    selectedindex = null;
                    if (questionindex <
                        questionobject.codingQuizData.length - 1) {
                      questionindex++;
...
//answer check
  Color selectedanswer(int index) {
    if (selectedindex != null &&
        index == questionobject.codingQuizData[questionindex]["answer"]) {
      return Color_const.mycustomgreen;
    }
    if (selectedindex == index) {
      if (selectedindex ==
          questionobject.codingQuizData[questionindex]["answer"]) {
        return Color_const.mycustomgreen;
      } else {
